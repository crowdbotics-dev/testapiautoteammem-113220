...
## Project Structure
    ...
    ├── testapiautoteammem_113220  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_113220`
...
2. Clone this repo and `cd testapiautoteammem_113220`
